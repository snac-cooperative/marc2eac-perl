...
<xsl:stylesheet xmlns:ead="urn:isbn:1-931666-22-9"
    ...
    <!-- example:
        ...
        Person example. Corp and family are similar.
    ...
    <!-- example:
        cpfDescription/description/localDescription@localType
    ...
    <!-- example:
         resourceRelation@xlink:arcrole
         socialarchive.iath.virginia.edu/snac/data/99166-w6870195.xml
    -->
    ...
    <!-- example:
         cpfRelation@xlink:arcrole
         http://socialarchive.iath.virginia.edu/snac/data/99166-w6jh3kqj.xml

        Used for NARA authority records starting Feb 24 2015. Also used in a few later repositories that have
        links to sameAs authority records.
    -->
    ...
    <!--
        ...
        term#ead/item
        term#ead/label
        http://socialarchive.iath.virginia.edu/snac/data/99166-w64p4nvj.xml
    ...
    <!-- 
         ...
         creatorOf. There is no mention of this in any .xsl file, so it appears not to be used.
